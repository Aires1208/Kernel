...
public class XServiceDashBoardSerializer extends JsonSerializer<XServiceDashBoard> {

    @Override
    public void serialize(XServiceDashBoard xServiceDashBoard, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {

        jgen.writeStartObject();

        jgen.writeFieldName("summary");
        jgen.writeObject(xServiceDashBoard.getxService());

        jgen.writeFieldName("topo");
        jgen.writeObject(xServiceDashBoard.getTopo());

        XLoadInfo xLoadInfo = xServiceDashBoard.getxLoadInfo();
