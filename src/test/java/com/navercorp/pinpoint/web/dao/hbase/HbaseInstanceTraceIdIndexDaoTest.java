...
public class HbaseInstanceTraceIdIndexDaoTest {
    ...
    @Test
    public void findInstanceTransactionIds() throws Exception {
        //given
        ...
        Set<TransactionId> transactionIds = instanceTraceIdIndexDao.findInstanceTransactionIds("fm-active", range);
    ...
    public void findTransactionIds() throws Exception {
        ...
        Set<TransactionId> transactionIds = instanceTraceIdIndexDao.findTransactionIds("fm-active", "/getTime", range);
